...
const BottomNav: React.FC<BottomNavProps> = ({ currentTab, onTabChange }) => {
  const navItems = [
    { id: 'calendar', label: '时光', icon: Calendar },
    { id: 'trends', label: '轨迹', icon: Activity },
    { id: 'divination', label: '觉察', icon: Sparkles, isCenter: true }, 
    { id: 'practice', label: '归息', icon: Flower2 },
    { id: 'soul', label: '感源', icon: User },
  ];
